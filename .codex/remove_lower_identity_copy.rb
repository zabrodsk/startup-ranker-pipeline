...
first_index = text.index(lower_block)
if first_index
  second_index = text.index(lower_block, first_index + lower_block.length)
  if second_index
    text = text[0...second_index] + text[(second_index + lower_block.length)..]
