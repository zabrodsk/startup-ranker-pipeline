...
def test_list_saved_jobs_prefers_terminal_snapshot_message_over_stale_terminal_progress(monkeypatch) -> None:
    import web.db as web_db
                    ...
                    [
                        {
                            ...
                            "created_at": "2026-03-13T11:01:00Z",
                        }
                    ]
                )
            if self.table_name == "analyses":
                    ...
                    [
                        {
                            "job_id_legacy": "job-456",
                            "status": "done",
                            "results_payload": {"job_status": "done", "job_message": "Analysis complete — 6/6 companies ranked"},
    ...
    assert rows == [
        {
            "job_id": "job-456",
            "status": "done",
            "progress": "Analysis complete — 6/6 companies ranked",
            "created_at": "2026-03-13T11:05:00Z",
            "input_mode": "specter",
            "use_web_search": True,
            "run_config": {},
